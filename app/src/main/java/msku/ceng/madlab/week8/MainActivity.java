...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int REQUEST_EXTERNAL_STORGE = 1;
    private static String [] PERMİSİON_STORAGE = {
        ...
        btnDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(permission != PackageManager.PERMISSION_GRANTED){
                    ActivityCompat.requestPermissions(MainActivity.this,PERMİSİON_STORAGE,
                            REQUEST_EXTERNAL_STORGE);
                }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults, int deviceId) {
        ...
        if(requestCode == REQUEST_EXTERNAL_STORGE){
            ...
            Toast.makeText(this, "Eternal Storage permission not granted", Toast.LENGTH_SHORT).show();
        }
    }
}